...
public class FlowLogicRefFromJavaTest {
    ...
    @Test
    public void test() {
        FlowLogicRefFactoryImpl.INSTANCE.create(JavaFlowLogic.class, new ParamType1(1), new ParamType2("Hello Jack"));
    }

    @Test
    public void testNoArg() {
        FlowLogicRefFactoryImpl.INSTANCE.create(JavaNoArgFlowLogic.class);
    }
}
